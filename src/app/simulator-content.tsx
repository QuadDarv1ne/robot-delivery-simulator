...
import { IMUView } from '@/components/simulator/imu-view'
import { ControlPanel } from '@/components/simulator/control-panel'
import { UnityWebGLPlayer } from '@/components/simulator/unity-webgl-player'
...
export default function SimulatorContent({ user, onLogout, onShowProfile, onShowAdmin }: SimulatorContentProps) {
  const { state, isOnline, sendCommand } = useSimulator()
                  ...
                  <CardContent className="pt-4 space-y-4">
                    {sensorData ? (
                      <>
                        ...
                        <Separator />
                        <div>
                          <div className="text-xs text-muted-foreground mb-1 flex items-center gap-1"><Settings className="w-3 h-3" />Энкодеры</div>
                  ...
                  <CardContent className="pt-4 space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="space-y-2 text-xs">
                        <div className="flex items-center gap-2"><Badge variant="secondary">move</Badge><span className="text-muted-foreground">Начать движения</span></div>
