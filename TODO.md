...
#### Важные
- [ ] Добавить тесты для новых API endpoints (Jest)
- [ ] Добавить обработку ошибок в API (валидация входных данных)
- [ ] Добавить пагинацию на клиенте (AlgorithmEditor, ScenarioEditor)
- [ ] Реализовать недостающие WebSocket команды для симулятора

#### Улучшения
- [ ] Добавить фильтрацию по дате создания/обновления
...
#### Документация
- [ ] Обновить README с описанием новых функций
- [ ] Добавить скриншоты функционала
